    ...
    "src/rule_providers.ts"() {
      ...
      ruleProviders = {
        ...
        zer0direct: {
          ...
          format: "yaml",
          interval: 86400,
          url: `${CDN_URL}/gh/Zer0wAve/zer0plan@main/ruleset/zer0direct.yaml`,
          path: "./ruleset/zer0direct.yaml"
        },
        zer0proxy: {
          type: "http",
          behavior: "domain",
          format: "yaml",
          interval: 86400,
          url: `${CDN_URL}/gh/Zer0wAve/zer0plan@main/ruleset/zer0proxy.yaml`,
          path: "./ruleset/zer0proxy.yaml"
        },
        BiliIntl: {
          type: "http",
          behavior: "domain",
